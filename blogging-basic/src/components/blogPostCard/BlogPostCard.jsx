        ...
        <div className="container px-5 py-10 mx-auto max-w-7xl ">
          ...
          <div className="flex flex-wrap justify-center -m-4 mb-5">
            ...
            <div className="p-4 md:w-1/3" >
              ...
              >
                {/* Blog Thumbnail  */}
                <img className=" w-full" src={'https://wallpapers.com/images/high/spaceman-giga-chad-uij12muihq8xayc0.webp'} alt="blog" />
            ...
            <div className="p-4 md:w-1/3" >
              ...
              >
                {/* Blog Thumbnail  */}
                <img className=" w-full" src={'https://images.pexels.com/photos/30159434/pexels-photo-30159434/free-photo-of-intricate-floral-patterns-at-sheikh-zayed-mosque.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'} alt="blog" />
